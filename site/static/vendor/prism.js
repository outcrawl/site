/* http://prismjs.com/download.html?themes=prism&languages=markup+css+clike+javascript+bash+c+csharp+cpp+docker+go+graphql+handlebars+http+java+json+lua+makefile+properties+protobuf+scss+sql+typescript+yaml&plugins=line-highlight+command-line */
...
function highlightLines(pre, lines, classes) {
	...
	for (var i=0, range; range = ranges[i++];) {
		...
		//line.style.top = (start - offset - 1) * lineHeight + 'rem';
    line.style.top = (start - offset - 1) * 1.5 + 'rem';
